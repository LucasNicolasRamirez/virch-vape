...
export const productosData = [
  ...
  { id: 26, nombre: 'Kit Starter Plus', marca: 'Vape Plus', precio: 40000, descripcion: 'Kit de inicio con características avanzadas para una experiencia de vapeo superior.', imagen: prod3, stock: 6, categoriaId: 'kits-de-inicio' },
  ...
  { id: 29, nombre: 'Kit Vaper X', marca: 'Vape X', precio: 47000, descripcion: 'Kit avanzado de inicio, perfecto para quienes quieren un vapeo potente y duradero.', imagen: prod3, stock: 5, categoriaId: 'kits-de-inicio' },
  ...
  { id: 32, nombre: 'Kit Avanzado X', marca: 'VapeX', precio: 92000, descripcion: 'Un kit completo con mod, atomizador y baterías de alta calidad, ideal para el vaper experto.', imagen: prod3, stock: 3, categoriaId: 'kits-avanzados' },
  ...
  { id: 36, nombre: 'Kit Master Vape', marca: 'MasterVape', precio: 115000, descripcion: 'El kit definitivo para quienes quieren experimentar el vapeo al máximo nivel.', imagen: prod3, stock: 5, categoriaId: 'kits-avanzados' },
  ...
  { id: 38, nombre: 'Mod Vaporesso Luxe', marca: 'Vaporesso', precio: 42000, descripcion: 'Mod de 220W con pantalla a color y tecnología avanzada.', imagen: prod3, stock: 4, categoriaId: 'mods' },
  ...
  { id: 42, nombre: 'Mod Smok Alien', marca: 'Smok', precio: 46000, descripcion: 'Mod de 220W con diseño innovador y potencia para grandes nubes de vapor.', imagen: prod3, stock: 6, categoriaId: 'mods' },
  ...
  { id: 45, nombre: 'Atomizador Sub-Ohm', marca: 'VapeTank', precio: 28000, descripcion: 'Atomizador sub-ohm con gran capacidad y excelente flujo de aire.', imagen: prod3, stock: 6, categoriaId: 'atomizadores' },
  { id: 46, nombre: 'Atomizador Tank Pro', marca: 'VapePro', precio: 32000, descripcion: 'Atomizador de tanque con sistema de relleno fácil y gran producción de vapor.', imagen: prod3, stock: 5, categoriaId: 'atomizadores' },
  ...
  // Baterías
  { id: 49, nombre: 'Batería 18650', marca: 'Vape Battery', precio: 2500, descripcion: 'Batería recargable de alta calidad para dispositivos de vapeo.', imagen: prod3, stock: 20, categoriaId: 'baterias' },
  { id: 50, nombre: 'Batería 21700', marca: 'Vape Power', precio: 3500, descripcion: 'Batería de alto voltaje 21700 para mods de alta potencia.', imagen: prod3, stock: 10, categoriaId: 'baterias' },
  ...
  { id: 57, nombre: 'Cargador Inteligente', marca: 'SmartCharge', precio: 7000, descripcion: 'Cargador inteligente con pantalla LCD que indica el estado de carga.', imagen: prod3, stock: 6, categoriaId: 'cargadores' },
  { id: 58, nombre: 'Cargador Xtar', marca: 'Xtar', precio: 7500, descripcion: 'Cargador avanzado de baterías con tecnología de carga rápida.', imagen: prod3, stock: 5, categoriaId: 'cargadores' },
  ...
  // Consumibles
  { id: 61, nombre: 'Algodón Vape', marca: 'CottonVape', precio: 1500, descripcion: 'Algodón de alta calidad para el proceso de wicking en vapes.', imagen: prod3, stock: 20, categoriaId: 'consumibles' },
  ...
  { id: 66, nombre: 'Jugo de Glicerina', marca: 'VG Base', precio: 3500, descripcion: 'Base de glicerina vegetal de alta calidad para mezclar con sabores.', imagen: prod3, stock: 5, categoriaId: 'consumibles' },
  ...
  { id: 68, nombre: 'Herramientas de Vapeo', marca: 'Vape Tool', precio: 2500, descripcion: 'Kit de herramientas completas para un mantenimiento adecuado de tu equipo.', imagen: prod3, stock: 10, categoriaId: 'accesorios' },
  ...
  { id: 71, nombre: 'Base de Vaporización', marca: 'VapeBase', precio: 1000, descripcion: 'Base de vaporización para mejorar la producción de vapor y el sabor.', imagen: prod3, stock: 9, categoriaId: 'accesorios' },
  ...
  { id: 74, nombre: 'Cargador Doble', marca: 'VapeCharge', precio: 5000, descripcion: 'Cargador para baterías 18650, permite cargar dos baterías a la vez.', imagen: prod3, stock: 15, categoriaId: 'otros' },
  ...
  { id: 77, nombre: 'Estuche de Vapeo', marca: 'VapeCase', precio: 4500, descripcion: 'Estuche protector para tu vape y accesorios, ideal para transporte seguro.', imagen: prod3, stock: 12, categoriaId: 'otros' },
