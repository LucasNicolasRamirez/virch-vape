  ...
  return (
    <div className={styles.Nosotros}>
      ...
      <div className={styles.textContainer}>
        ...
        <Typography>Nuestro nombre refleja nuestro vínculo con esta región, y nos hemos convertido en una de las pocas
        opciones de referencia para los vapeadores de la zona.</Typography>
        <Typography>
